...
int main()
{
    const char * line = "Kevin y yo no tenemos trabajo";//string a almacenar en el qr
    QRcode *myqrcode; //estructura del qr
    myqrcode = QRcode_encodeString(line, 4, QR_ECLEVEL_H, QR_MODE_8,1);//generador del bitmap del qr con la bibliotena qrencode
    writePNG(myqrcode,"filename.png");//traduccion del bitmap a una imagen png
